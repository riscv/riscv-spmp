...
Contributors to this specification are contained in link:sspmp/contributors.adoc[contributors] and link:spmp-for-hyp/contributors.adoc[contributors] files.
