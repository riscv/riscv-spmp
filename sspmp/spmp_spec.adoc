...
The RISC-V SPMP mechanism provides per-hart control registers in supervisor mode.
...
[[spmpencode]]
image::SPMP_Encoding_Table_v13.svg[title="SPMP Encoding Table"]
...
In a system with N SPMP entries (asciimath:[N \le 64]),
